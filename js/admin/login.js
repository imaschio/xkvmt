	...
	$("#forgot_password").click(function()
	{
		if(!forgot_form)
		{
			forgot_form = new Ext.FormPanel(
			{
				...
				items: [
				{
					fieldLabel: intelli.admin.lang[intelli.config.lang].email,
					name: 'email',
					emptyText: intelli.admin.lang[intelli.config.lang].type_username_email,
					allowBlank: false
				}],
				buttons: [
				{
					text: intelli.admin.lang[intelli.config.lang].email,
					handler: function()
					{
						if(forgot_form.form.isValid())
						{
							forgot_form.form.submit(
							{
								...
								success: function(form, action)
								{
									...
									Ext.Msg.show(
									{
										title: intelli.admin.lang[intelli.config.lang].restore_password,
										msg: msg,
										buttons: Ext.Msg.OK,
					...
					text: intelli.admin.lang[intelli.config.lang].cancel,
					handler: function()
					{
						forgot_form.form.reset();
						forgot_win.hide();
