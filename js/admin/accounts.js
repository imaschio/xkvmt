...
intelli.exGModel = Ext.extend(intelli.gmodel,
{
	...
	setupReader: function()
	{
		this.record = Ext.data.Record.create([
			...
			{name: 'ip address', mapping: 'ip_address'},
			{name: 'listings', mapping: 'listings'},
			{name: 'email', mapping: 'email'},
			{name: 'status', mapping: 'status'},
			{name: 'sponsored_expire_date', mapping: 'sponsored_expire_date'},
	...
	setupColumnModel: function()
	{
		...
		this.checkColumn,
		{
			...
			header: intelli.admin.lang.login,
			dataIndex: 'login',
			sortable: false,
			width: 70
		},{
			header: intelli.admin.lang.ip_address,
			...
			dataIndex: 'sponsored_expire_date',
			sortable: false,
			hidden: true,
			width: 130,
...
intelli.exGrid = Ext.extend(intelli.grid,
{
	...
	setupBaseParams: function()
	{
		...
		{
			search = intelli.urlVal('quick_search').replace('+',' ');
		}
	...
	setRenderers: function()
	{
		...
		/* add edit link */
		this.columnModel.setRenderer(11, function(value, metadata)
		{
		...
		/* add remove link */
		this.columnModel.setRenderer(12, function(value, metadata)
		{
...
Ext.onReady(function()
{
	...
	if (Ext.get('sponsored_expire_date'))
	{
		new Ext.form.DateField(
		{
			allowBlank: false,
			format: 'Y-m-d',
			applyTo: 'sponsored_expire_date',
			value: Ext.get('sponsored_expire_date').getValue()
		});
	}
