<form action="<?php echo URL_INSTALL ?><?php echo $this->module ?>/configuration/" method="post" class="form-horizontal">
	...
	<div class="row">
		<div class="span4">
			...
			<p>Configure correct paths and URLs to your eSyndiCat CMS.</p>
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						<select disabled="disabled">
							<option value="<?php echo $this->templates[0] ?>"><?php echo ucfirst($this->templates[0]) ?></option>
						</select>
				...
				<div class="control-group">
					...
					<div class="controls">
						<select name="debug" id="debug">
							<option value="0"<?php if (iaHelper::getPost('debug', 0) == 0): ?> selected="selected"<?php endif ?>>Do not display any errors</option>
							<option value="1"<?php if (iaHelper::getPost('debug', 0) == 1): ?> selected="selected"<?php endif ?>>Display critical errors</option>
							<option value="2"<?php if (iaHelper::getPost('debug', 0) == 2): ?> selected="selected"<?php endif ?>>Display errors in debug panel</option>
						</select>
					</div>
				</div>
			</div>
	...
	<div class="row">
		<div class="span4">
			...
			<p>Setting up eSyndiCat CMS to run on your server involves 3 simple steps...</p>
			<p>Please enter the hostname of the server eSyndiCat CMS is to be installed on.</p>
			<p>Enter the MySQL username, password and database name you wish to use with eSyndiCat CMS.</p>
			<p>Enter the a table name prefix to be used by eSyndiCat CMS and select what to do with existing tables from former installations.</p>
		</div>
		<div class="span8">
			<div class="well">
				...
				<div class="control-group" id="err_prefix">
					...
					<div class="controls">
						<input type="text" name="prefix" id="prefix" value="<?php echo iaHelper::getPost('prefix', 'esc' . IA_VER . '_', false) ?>" />
						<span class="help-inline" style="display: none;">Prefix is incorrect.</span>
					</div>
				</div>
				<div class="control-group">
				...
				<div class="control-group">
					<label class="control-label" for="sample_data">Install Sample Data: </label>
					<div class="controls">
						<label class="checkbox">
							<input type="checkbox" id="sample_data" name="sample_data"<?php if (iaHelper::getPost('sample_data', false)): ?> checked="checked"<?php endif ?> />
							Install some sample data to start with.
						</label>
					</div>
				</div>
