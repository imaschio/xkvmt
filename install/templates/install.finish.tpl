<div class="row">
	<div class="span4">
		...
		<?php endif ?>
		<p><strong>Thank you for choosing eSyndiCat CMS.</strong></p>
	</div>
	<div class="span8">
		<div class="well">
			<div>
				...
				You should upload this file to the same directory where you have eSyndiCat CMS.
			...
			<div>
				...
				You MUST save config.inc.php file to your local PC and then upload to eSyndiCat CMS includes directory.
				<?php else: ?>
				...
				<form method="post" action="<?php echo URL_INSTALL ?><?php echo $this->module ?>/download/">
					...
					<button type="submit" class="btn btn-success"><i class="icon-download-alt icon-white"></i> Download config file</button>
				</form>
			</div>
			<div>
...
<div style="<?php if (empty($this->description)): ?>display: none; '<?php endif ?>margin: auto; border: 1px solid #777; background-color: #ededed; padding:10px; overflow: scroll; width:650px;" id="file_content" class="well">
