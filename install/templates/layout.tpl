...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title><?php echo $this->steps[$this->step] ?> :: eSyndiCat CMS Web Installer</title>
	...
	<body>
		...
		<div id="top-bar">
			<div class="container">
				<a class="logo" href="<?php echo URL_INSTALL ?>">
					<img alt="eSyndiCat CMS" src="<?php echo URL_INSTALL ?>templates/img/logo.png">
				</a>
				<ul class="nav nav-inventory">
					<li class="contacts"><a href="http://www.esyndicat.com/contact-us.html" title="Contact us if you have any questions." target="_blank">Contacts</a></li>
					<li class="help"><a href="http://www.esyndicat.com/desk/" title="Submit a ticket and get a fast reply." target="_blank">Helpdesk</a></li>
					<li class="forums"><a href="http://www.esyndicat.com/forum/" title="Ask questions in our user forums." target="_blank">User Forums</a></li>
				</ul>
			</div>
		</div>
		...
		<div id="teaser">
			<div class="container">
				<h1>
					...
					<small>switch to <a href="<?php echo URL_INSTALL ?>upgrade/">Upgrade Wizard</a></small>
					<?php endif ?>
					<?php if ($this->module == 'upgrade' && in_array('install', $this->modules)): ?>
					<small>switch to <a href="<?php echo URL_INSTALL ?>install/">Installation Wizard</a></small>
					<?php endif ?>
				</h1>
				<div id="progress-bar">
		...
		<footer>
			<div class="container">
				<p>Powered by <a href="http://www.esyndicat.com/" title="Open Source CMS">eSyndiCat CMS</a> Version <?php echo IA_VERSION ?><br> Copyright &copy; <?php echo date('Y') ?> <a href="http://www.intelliants.com/" title="Software Development Company">Intelliants LLC</a></p>
			</div>
		</footer>
