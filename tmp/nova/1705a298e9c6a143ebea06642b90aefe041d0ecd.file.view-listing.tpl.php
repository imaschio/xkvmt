<?php /* Smarty version Smarty-3.1.13, created on 2015-02-27 04:27:04
         compiled from "/home/wwwsyaqd/public_html/templates/common/view-listing.tpl" */ ?>
<?php /*%%SmartyHeaderCode:70348687554f03868b86bf1-27665083%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1705a298e9c6a143ebea06642b90aefe041d0ecd' => 
    array (
      0 => '/home/wwwsyaqd/public_html/templates/common/view-listing.tpl',
      1 => 1425025902,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '70348687554f03868b86bf1-27665083',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54f03868d48c87_68203046',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54f03868d48c87_68203046')) {function content_54f03868d48c87_68203046($_smarty_tpl) {?><?php if (!is_callable('smarty_function_ia_hooker')) include '/home/wwwsyaqd/public_html/includes/smarty/custom/function.ia_hooker.php';
...
<div class="media ia-item" id="listing-<?php echo $_smarty_tpl->tpl_vars['listing']->value['id'];?>
">
...
" <?php if ($_smarty_tpl->tpl_vars['config']->value['external_no_follow']){?> rel="nofollow"<?php }?>data-item="listings"><?php echo $_smarty_tpl->tpl_vars['listing']->value['title'];?>
</a></dd>
			<?php }?>
...
"><?php echo $_smarty_tpl->tpl_vars['crossed_category']->value['title'];?>
				...
				<?php }?>
			<?php }?>
			<?php if ($_smarty_tpl->tpl_vars['config']->value['accounts']&&$_smarty_tpl->tpl_vars['listing']->value['account_username']){?>
				<dt><?php echo smarty_function_lang(array('key'=>'account'),$_smarty_tpl);?>
</dt>
				<dd><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['print_account_url'][0][0]->printAccountUrl(array('account'=>$_smarty_tpl->tpl_vars['listing']->value,'prefix'=>'account_'),$_smarty_tpl);?>
"><?php echo $_smarty_tpl->tpl_vars['listing']->value['account_username'];?>
</a></dd>
			<?php }?>
