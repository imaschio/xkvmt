...
final class PageRank
{
	...
	public static function getPageRank($q, $context = null)
	{
		...
		return $response ? end($result) : 0;
	}

	// Convert a string to a 32-bit integer
	private static function _strtonum($str, $check, $magic)
	{
	...
	private static function _makehash($string)
	{
	...
	private static function _checksum($hashnum)
	{
		$checkbyte = 0;
		$flag = 0;
