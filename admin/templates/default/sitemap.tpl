...
<div style="position:relative;border:1px solid #76A9DC; height:33px; width:100%; background-color:#ffffff;color:#335B92;text-align:center;">
	...
	<div id="progress_bar" style="height:33px; width:0%; background:url(templates/{$config.admin_tmpl}/img/bgs/progress_bar.gif) left repeat-x;color:#335B92;"></div>
</div>
...
{include_file js="js/admin/sitemap"}
