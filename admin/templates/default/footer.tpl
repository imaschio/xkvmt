...
<div class="footer">
	<div>
		Powered by <a href="http://www.esyndicat.com/" target="_blank">eSyndiCat Pro v{$config.version}</a><br />
		Copyright &copy; {$smarty.now|date_format:"%Y"} <a href="http://www.intelliants.com/" target="_blank">Intelliants LLC</a>
	</div>
</div>
<!-- footer end -->
